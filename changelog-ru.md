...
`*` Переписано окно всплывающего сообщения для лучшего отображения длинных сообщений (также добавлены настройки <em>extensions.handyclicks.notifyMessageMaxWidth</em> и <em>extensions.handyclicks.notifyMessageMaxHeight</em>).<br>
