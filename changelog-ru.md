...
`*` Добавлено меню для отключения/восстановления каждого предупреждающего сообщения (вместо всплывающей подсказки и возможности восстановить все предупреждения).<br>
