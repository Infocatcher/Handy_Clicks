...
`+` Добавлен базовый экспорт/импорт для отдельных *.js файлов (`//> %hc_PrefsDir%/scripts/example.js` в коде) (<a href="https://github.com/Infocatcher/Handy_Clicks/issues/32">#32</a>).<br>
