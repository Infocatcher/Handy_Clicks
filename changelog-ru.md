...
`+` Редактор: добавлена кнопка и контекстное меню для переименования сочетания кнопки мыши и модификаторов.<br>
...
`+` Редактор: добавлено сочетание клавиш Shift+F2 для открытия меню настроек.<br>
