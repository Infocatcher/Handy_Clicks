...
`*` Добавлена алфавитная сортировка родительских строк в инвертированном режиме и сортировка .<br>
...
`*` Упрощен код для выделения настроек в дереве перемещением мыши (нажать кнопку мыши и выделять перетаскиванием).<br>
