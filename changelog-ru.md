...
`*` Редактор: добавлены иконки для вкладок «Действия» и «Добавленные типы» (использованы <a href="https://www.fatcow.com/free-icons">Farm-Fresh Web Icons от FatCow Web Hosting</a>).<br>
